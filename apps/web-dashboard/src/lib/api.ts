...
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL ?? (import.meta.env.DEV ? "https://jobsa-backend-307842804501.us-central1.run.app" : "https://jobsa-backend-307842804501.us-central1.run.app");
